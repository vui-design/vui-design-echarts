...
<style>
  ...
  .example-case .actions { display:flex; justify-content:center; align-items:center; padding:12px 0; }
  ...
  .example-code pre { box-sizing:border-box !important; display:block !important; width:100% !important; height:100% !important; margin:0 !important; padding:0 !important; }
  .example-code pre code { box-sizing:border-box !important; display:block !important; border:none !important; border-radius:0 !important; width:100% !important; height:100% !important; background-color:transparent !important; padding:24px !important; overflow-x:hidden; overflow-y:hidden; color:rgba(0,0,0,0.65) !important; font-size:13px !important; font-family:"Lucida Console", Consolas, Monaco, "Andale Mono", "Ubuntu Mono", monospace !important; }
